...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self buildRealmSchemaVersion];
    [self buildCustomize];
    
    RootTabBarController *vc = [RootTabBarController new];
    self.window.rootViewController = vc;

    return YES;
}
- (void)buildRealmSchemaVersion {
...
- (void)buildCustomize {
    self.window.tintColor = kSubjectColor;
    
    UINavigationBar *navigationBarAppearance = [UINavigationBar appearance];
    
    [navigationBarAppearance setTranslucent:FALSE];
    //[[UINavigationBar appearance] setBackgroundColor:kSubjectColor];
    [navigationBarAppearance setTintColor:[UIColor whiteColor]];
    //[navigationBarAppearance setBarTintColor:kSubjectColor];
